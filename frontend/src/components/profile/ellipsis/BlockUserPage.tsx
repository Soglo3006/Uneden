...
export default function BlockUserPage({ profileId, displayName, onBack, onClose }: Props) {
  ...
  return (
    <Card className="p-6 space-y-4">
      <p className="text-gray-900 font-bold text-2xl text-center">Are you sure you want to block {displayName}?</p>
      ...
      <div className="flex gap-3">
        <Button variant="outline" className="flex-1 cursor-pointer" onClick={onBack} disabled={loading}>Cancel</Button>
